...
include('../connect.php');
$id=$_GET['id'];
$result = mysqli_query($link,"SELECT * FROM casher where id='$id'");
...
<form name="myForm" action="editinfocexec.php" method="post" enctype="multipart/form-data" name="addroom" onsubmit="return validateForm()">
